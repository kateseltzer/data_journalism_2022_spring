...
Certainly hope it's not just ~racism~ but would be good to look into further. Maybe people just live and work in different areas? 
...
There are a total of 13 loans, 4 in 20701, 6 in 21031, and 3 in 21240. The loan amounts total $681,553,407.50. It's possible people mostly work and do not live in these areas.
```{r}
# Write the code to produce your answer here
maryland_ppp_with_naics_and_zcta %>% 
...
44. I'd be interested to look into the executive and legislative branches loan -- I wouldn't think either of those would qualify as a small business at all?

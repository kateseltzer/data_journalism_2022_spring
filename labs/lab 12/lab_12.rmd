...
write_csv(maryland_zips_yyyymmdd.csv, paste(tzone))
write_csv(non_maryland_zips_yyyymmdd.csv, paste, tzone))
...
ggplot() +
  geom_sf(data=md_zips_and_vax, aes(fill=percent_vaxxed)) +

...
international_migration<-read_csv("data/tabula-md-statistical-handbook.csv",skip=2, col_names=c("state/jurisdiction", "year_2010_2011", "year_2011_2012", "year_2012_2013", "year_2013_2014","year_2014_2015","year_2015_2016","year_2016_2017","year_2017_2018", "year_2018_2019","total"))
...
Suburban Washington Region and Montgomery County
```{r}
# Write the code to produce your answer here
international_migration %>% 
  mutate(percent_international_migration=(total/198996)*100) %>% 
  arrange(desc(percent_international_migration))
```
...
The greatest international migration occurred in some of most Maryland's most urban and populous regions, like Baltimore and Prince George's County. More rural areas made up a very small percentage of of Maryland's international migration.
...
Calvert and Southern Maryland Region
```{r}
# Write the code to produce your answer here
international_migration %>% 
  mutate(percent_change_18_19=(year_2017_2018 - year_2016_2017)/year_2016_2017) %>%
  arrange(percent_change_18_19)

```

**Q4** What's your best guess as to why these changes occurred, and in those places in particular?
**A4** [write your answer here]
Maybe changing political environments -- could have become more rural, conservative, white, etc.
...
```{r}
# Write the code to load the CSV file here
domestic_migration<-read_csv("data/tabula-md-statistical-handbook-domestic.csv",skip=2,col_names=c("state/jurisdiction","year_10_11","year11_12","year_12_13","year_13_14","year_14_15","year_15_16","year_16_17","year_17_18","year_18_19","total"))
```
...
# Write the code to produce your answer here
domestic_migration %>% 
  filter(year_16_17>0&year_17_18>0&year_18_19>0)

```

**Q7** How would you describe this data? Is there a county or region that stands out, and why?
**A7** [write your answer here]
Frederick is especially interesting because it seemed to have massive growth in migration very quickly. It jumped from 452 people in 2015-2016, to 2,206 in 2016-2017 and 3,050 in 2017-2018.

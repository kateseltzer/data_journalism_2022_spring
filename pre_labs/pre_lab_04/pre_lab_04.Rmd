...
**Answer**
Yes. Differences in pop estimate and year. 
```{r}
...
**Answer**
can't join because of incompatible types - joins don't work if they're not the same data type (can't join character to number)
```{r}
...
**Answer**
Rural:	145, $44815.22, $19064.57
Urban: 41823,	$55584.05,	$19950.00
```{r}
...
**Answer**
Rural: 18083, $74463.32, $20833
Urban: 93973,	$92029.39,	$20833

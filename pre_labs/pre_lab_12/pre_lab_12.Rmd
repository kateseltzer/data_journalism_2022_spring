...
**Answer**
13 columns, 11,397 rows - columns include vaccination date, county, how many people received their and second dose on that day, how many people in the county have received that dose -- lots of NAs for county
```{r}
...
**Answer**
data frame by county, number of days there's data. pretty big number of days with NA or Unknown. also just generally the counties vary
...
**Answer**
Not sure. Doesn't seem super relevant to what we need, it's not a county.
...
**Answer**
Over the most recent 7-10 days, the number of vaccinations in Prince George's fell pretty steadily, with a sharp drop off between March 5 and March 6
```{r}
...
**Answer**
The number of vaccinations sharply spiked as they became more widely available, between April and maybe May or June of 2021. It then steadily decreased through about August of 2021, with much smaller increases in the fall and winter.
```{r fig.width=9}
ggplot() +
...
**Answer**
shows counties like Montgomery, Prince George's and Kent had the greatest number of vaccinations
```{r}
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
shows most of the counties steadily increasing over time
```{r}
...
**Answer**
map with number of cases color coded, 
```{r}
ggplot() +

...
**Answer**
DEALE --> titlecase, CATONSVILLE --> titlecase
```{r}
...
**Answer**
ABELL --> Abell, aberdeen --> Aberdeen, ADELPHI --> Adelphi
```{r}
cleaned_md_loans %>%
...
**Answer**
Did not see many (any) substantial differences
```{r}
cleaned_md_loans <- md_loans %>%

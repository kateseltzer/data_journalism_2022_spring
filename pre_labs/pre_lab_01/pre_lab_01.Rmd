...
```{r}
ppp_maryland_loans <- read_rds("~/GitHub/data_journalism_2022_spring/pre_labs/pre_lab_01/pre_lab_01.rds")
```
...
**Answer**name = character, amount = numeric
